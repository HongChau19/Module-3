...
public class MatBang {
    ...
    public MatBang(String maMatBang, double dienTich, String trangThai, int tang, String loaiMatBang, double giaThue, Date ngayBatDau, Date ngayKetThuc, String moTaChiTiet) {
